...
import { router as sanguineTraceRouter } from './endpoints/sanguine-trace.js';
import { router as sanguineLedgerRouter } from './endpoints/sanguine-ledger.js';
...
export function setupPrivateEndpoints(app) {
    ...
    app.use('/api/sanguine-trace', sanguineTraceRouter);
    app.use('/api/sanguine-ledger', sanguineLedgerRouter);
