/**
 * sanguine-trace — the prompt->output trace for the fold extension.
 *
 * fold (`public/scripts/extensions/sanguine/`) runs one shared LLM call per extraction cycle: it
...
export function traceDirectory(userDirectories) {
    const dir = path.join(userDirectories.extensions, 'sanguine-traces');
