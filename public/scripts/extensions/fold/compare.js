 ...
 *
 *     node public/scripts/extensions/fold/compare.js <chat-id> [a-why] [b-why]
 *
...
const TRACES = path.join('data', 'default-user', 'extensions', 'fold-traces');
...
if (!chatId) {
    console.error('usage: node public/scripts/extensions/fold/compare.js <chat-id> [a-why] [b-why]');
    process.exit(1);
}
